...
type Repository interface {
	...
	AddRefreshToken(token *entity.RefreshToken) (*entity.RefreshToken, error)
	...
	FindRefreshTokenByID(id *primitive.ObjectID) (*entity.RefreshToken, error)

	// Deletes the entity.RefreshToken
	// If the RefreshToken doesn't exist returns err("refreshToken doesn't exist")sxy
	DeleteRefreshToken(id *primitive.ObjectID) error
}
